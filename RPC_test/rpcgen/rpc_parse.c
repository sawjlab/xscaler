...
static isdefined(definition *defp);
static def_struct(definition *defp);
static def_program(definition *defp);
static def_enum(definition *defp);
static def_const(definition *defp);
static def_union(definition *defp);
static def_typedef(definition *defp);
static get_declaration(declaration *dec, defkind dkind);
static get_type(char **prefixp, char **typep, defkind dkind);
static unsigned_dec(char **typep);
