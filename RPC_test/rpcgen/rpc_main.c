...
static c_output(char *infile, char * define, int extend, char *outfile);
static h_output(char *infile, char *define, int extend, char *outfile);
static s_output(int argc, char *argv[], char *infile, char *define,
		int extend, char *outfile, int nomain);
static l_output(char *infile, char *define, int extend, char *outfile);
static do_registers(int argc, char *argv[]);
static parseargs(int argc, char *argv[], struct commandline *cmd);
