...
static print_header(definition *def);
static print_trailer();
static space();
static emit_enum(definition *def);
static emit_union(definition *def);
static emit_struct(definition *def);
static emit_typedef(definition *def);
static print_stat(declaration *dec);
