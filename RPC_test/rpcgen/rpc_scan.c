...
static findstrconst(char **str, char **val);
static findconst(char **str, char **val);
static findkind(char **mark, token *tokp);
static cppline(char *line);
static directive(char *line);
static printdirective(char *line);
static docppline(char *line, int *lineno, char **fname);
